  ...
  Future<void> _signIn() async {
    ...
    if (response.isSuccess) {
      ...
      if (loginModel.data != null && loginModel.data!.isNotEmpty) {
        UserModel firstUser = loginModel.data!.first;
        print("First user data: ${firstUser.toJson()}"); // Print the user data to ensure it's correct

        await AuthController.saveUserData(firstUser);
